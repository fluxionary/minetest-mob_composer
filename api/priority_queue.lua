...
function heap_class:size()
	return self._size
end

function heap_class:peek_max()
	local hn = self._max_node
	return hn.value, hn.priority
end

function heap_class:delete(value)
	self:set_priority(value, inf)
	return self:delete_max()
end

function heap_class:delete_max()
...
function heap_class:get_priority(value)
...
function heap_class:set_priority(value, priority)
